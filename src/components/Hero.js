...
const Hero = () => {
  return (
    <section className="relative min-h-[90vh] flex items-center pt-20 overflow-hidden bg-white">
      ...
      <div className="absolute top-0 right-0 w-[45%] h-full bg-[#fb2576]/[0.02] -z-10 rounded-l-[200px] border-l border-gray-50 flex items-center justify-center overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center relative z-10 w-full">
        ...
        >
          <div className="flex items-center gap-3">
             ...
             <span className="text-[#fb2576] font-black tracking-[4px] uppercase text-[10px]">INDEPENDENT PERSPECTIVE</span>
          </div>
          <h1 className="text-5xl md:text-7xl font-black leading-[1.05] text-[#1a1a1a] uppercase italic tracking-tight">
            DECODING THE <br />
            <span className="text-[#fb2576]">NEXT GEN</span> OF <br />
            TECHNOLOGY.
          </h1>
          <p className="text-lg text-gray-500 max-w-lg font-medium leading-relaxed">
            A high-fidelity tactical content studio by <span className="text-[#1a1a1a] font-black">Yog Prakash Sah</span>. Exploring future tech, tactical productivity, and lifestyle engineering.
          </p>
          <div className="flex flex-wrap gap-4 pt-4">
            ...
            <Link href="/about" className="px-8 py-4 text-[11px] font-black uppercase tracking-widest border border-gray-100 rounded-[3px] hover:border-primary hover:text-primary transition-all">THE IDENTITY</Link>
          </div>
        </motion.div>
