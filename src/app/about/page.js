...
export const metadata = {
  title: 'About - Technoyogyai | Yog Prakash Sah',
  description: 'Learn about Yog Prakash Sah, the founder of Technoyogyai – a technology blogger sharing deep insights on future tech and digital lifestyle.',
};
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative pt-24 md:pt-32 pb-16 md:pb-24 overflow-hidden">
        <div className="absolute top-0 right-0 w-[45%] h-full bg-[#7a3983]/[0.02] -z-10 rounded-bl-[150px] md:rounded-bl-[200px] border-l border-gray-50 flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 sm:gap-20 items-center">
          <div className="flex flex-col gap-6 sm:gap-8">
            <h1 className="text-5xl md:text-7xl font-bold leading-none tracking-tight uppercase text-[#1a1a1a]">
              YOG <span className="text-[#7a3983]">PRAKASH</span> <br/> SAH.
            </h1>
            <p className="text-lg md:text-xl text-gray-500 leading-relaxed font-medium max-w-xl">
              A high-fidelity technology blogger and the founder of <span className="text-[#1a1a1a] font-bold">Technoyogyai</span>. We decode the intersection of modern innovation and tactical productivity.
            </p>
          ...
          <div className="relative h-[480px] md:h-[600px] group flex-shrink-0">
            <div className="absolute inset-0 bg-[#7a3983]/[0.03] rounded-[2px] translate-x-4 translate-y-4 -z-10 group-hover:translate-x-6 group-hover:translate-y-6 transition-transform" />
            <img
      ...
      <section className="py-20 md:py-24 bg-gray-50/50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col items-center text-center gap-4 mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1a1a1a] tracking-widest uppercase border-b-4 border-[#7a3983] pb-2">THE <span className="text-[#7a3983]">EDITORIAL</span> FOCUS</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {topics.map((item, i) => (
              <div key={i} className="flex flex-col gap-6 p-8 md:p-10 bg-white border border-gray-100 rounded-[2px] shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-500 group">
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-[2px] bg-gray-50 flex items-center justify-center text-[#7a3983] group-hover:bg-[#7a3983] group-hover:text-white transition-all border border-gray-100">
                  {item.icon}
                </div>
      ...
      <section className="py-24 md:py-32 bg-white relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-6 text-center flex flex-col gap-8 md:gap-10 items-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-gray-500 leading-relaxed font-medium max-w-2xl">
             I believe the best technology serves people — not the other way around. Through <span className="text-[#1a1a1a] font-bold">Technoyogyai</span>, I aim to bridge the gap between complex innovation and everyday understanding, empowering readers to make thoughtful choices in a hyper-connected world.
          </p>
        </div>
      </section>
