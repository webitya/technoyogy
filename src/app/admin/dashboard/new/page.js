            ...
            {activeTab === 'seo' && (
              <div className="flex flex-col gap-8 max-w-3xl">
                <div className="admin-card !p-8">
                  ...
                  <div className="p-6 rounded-[2px] bg-gray-50 border border-gray-100 border-l-4 border-l-[#fb2576]">
                    <p className="text-[9px] font-black text-[#fb2576] tracking-widest uppercase mb-1">technoyogyx.com › analytics › blog</p>
