        ...
        <div className="sticky top-0 z-30 flex items-center justify-between px-8 py-3 border-b border-gray-100 bg-white shadow-sm">
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-4">
              ...
              <h1 className="text-[12px] font-black text-[#1a1a1a] uppercase tracking-widest italic">NEW RECORD</h1>
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button type="button" onClick={() => handleSubmit(null, 'draft')} disabled={loading} className="admin-btn-secondary text-[10px] !py-2.5">SAVE AS DRAFT</button>
